...
4. Tune or extend the checked-in cluster launcher wrappers under `scripts/slurm/` so each stage can run with the right partition, memory, and runtime envelope on the target cluster.
