...
SEGMENT_INDEX_DEFAULTS: dict[str, Any] = {
    ...
    "raw_chunk_index": -1,
    "gmr_target_name": "",
    "causal_segment": False,
    "segment_alignment": "",
    "inactive_start": False,
    "activation_after_start": False,
    "contact_near_onset": False,
    "rejection_reason": "",
    "coarse_family": "",
    "proposal_size": 1,
    ...
    "target_key_ids": "[]",
    "target_key_ids_json": "[]",
    "chord_center_key_id": 0.0,
    "chord_center_key_id_normalized": 0.0,
    "chord_span_semitones": 0.0,
    "interval_pattern": "[]",
    "interval_pattern_bucket": "none",
    "white_black_pattern": "[]",
    "key_world_positions": "[]",
    "wrist_world_position": "[]",
    "wrist_world_orientation": "[]",
    "wrist_velocity": "[]",
    "wrist_to_chord_center_offset": "[]",
    "wrist_to_each_target_key_offset": "[]",
    "relative_wrist_anchor": "[]",
    "fingertip_world_positions": "[]",
    "fingertip_to_target_key_offsets": "[]",
    "nearest_finger_to_each_target_key": "[]",
    "nearest_finger_labels": "[]",
    "contact_finger_ids": "[]",
    "finger_set_id": "unknown",
    "finger_set": "unknown",
    "fingertip_height_above_key": "[]",
    "lateral_fingertip_key_offsets": "[]",
    "start_joint_state": "[]",
    "start_joint_velocity": "[]",
    "normalized_joint_state": "[]",
    "hand_side": "unknown",
    "key_inactive_at_segment_start": False,
    "key_activation_onset_step": -1,
    "contact_step": -1,
    "duration_bucket": 0,
    "dynamics_value": 0.0,
    "dynamics_bucket": 0,
    "motion_family": "",
    "primitive_frame_mode": "absolute",
}
